...
INSERT INTO public.product(name, subtitle, description, image, price, is_new, slug, dimension, category, weight)
	VALUES ('plateau bed and breakfast', 'Conseillé pour 3-4 personnes', 'Brioche moelleuse artisanale\n
			...
			('plateau fall in love', 'Conseillé pour 2 personnes', 
			'Brioche moelleuse artisanale\n Brioche aux pépites de chocolat artisanale\n Pancakes vanillés (fait-maison)\n Mini crêpes vanillées (fait-maison)\n Madeleines vanillées (fait-maison)\n Cake marbré (fait-maison)\n Fruits frais\n Pâte à tartiner et confiture (Alain Milliat).', 
			'plateau_fall_in_love', 29.90, true,'fall-in-love', 'diam. 24','plateau', 0.9),
			('mini brunch d''hiver', 'Conseillé pour 2 personnes', 
			'Brioche moelleuse artisanale\n Pancakes vanillés (fait-maison)\n Mini crêpes vanillées (fait-maison)\n Madeleines vanillées (fait-maison)\n Cake marbré (fait-maison)\n Fourme d''Ambert\n Cream cheese à l''huile d''olive et basilic frais\n Jambon Serrano affinage 12 mois\n Cantal entre deux AOP (lait cru)\n 
			Fruits frais, légumes croquants\n Pain artisanal tranché\n Pâte à tartiner et confiture (Alain Milliat).', 
			'plateau_mini_brunch_d_hiver',29.90, true,'mini-brunch-hiver', 'diam. 24','plateau', 0.9),
			( 'burrata à partager', 'Conseillé pour 2-3 personnes', 
			...
			('mini apéritif', 'Conseillé pour 3-4 personnes', 
			...
			'orange', 5.50, false,'jus-orange', '25cl', 'boisson', null),
			('prosecco riccadonna', '', 
			'Bouteille de Prosecco Riccadona de 75cl pour créer un cocktail mimosas, 4cl de jus d''orange mélangé à 8cl de prosecco', 
			'prosecco', 
 			12.90, false,
 			'prosecco', '75cl', 'boisson',null),    
			('thé noir - breakfast', '', 
