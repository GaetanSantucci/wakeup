    ...
    <div className={styles.gift__container}>
      <div className={styles.gift__container__details}>
        ...
        <div className={styles.gift__container__details__card}>
          ...
          <p>Il vous sera demandé les coordonnées de la personne (nom, prénom, adresse) à qui vous souhaitezl&apos;offrir. Ensuite vous la recevrez par mail une fois les modalités remplies.</p>
