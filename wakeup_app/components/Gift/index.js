    ...
    <div className={styles.gift__container}>
      <div className={styles.gift__container__details}>
        ...
        <div className={styles.gift__container__details__card}>
          ...
          <p>Il vous sera demandé les coordonnées de la personne (nom, prénom et adresse) à qui vous souhaitez offrir la carte cadeau. Nous réaliserons ensuite l&apos;e-carte cadeau que vous recevrez par mail.</p>
          <ul>Cette carte est :
