...
export default async function Products() {
  ...
  return (
    <>
      ...
      <p className={styles.product__text}>Nous vous proposons des plateaux gourmands, élégants et raffinés. Du petit-déjeuner, au brunch et jusqu&apos;à l&apos;apéritif, nous proposons une selection de plateaux avec des produits de qualité.</p>
