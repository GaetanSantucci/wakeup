      ...
      <div className={styles.container_item}>
        <div className={styles.container_social}>
          ...
          <div className={styles.container_social_logo}>
            <Link href='https://www.instagram.com/wakeup.clf/?hl=en' target='blank'><Image src={'/images/logo_instagram.png'} width={50} height={50} alt='logo instagram' /></Link>
            <Link href='https://www.facebook.com/people/wakeupclf/100069457776560/' target='blank'><Image src={'/images/logo_facebook.png'} width={50} height={50} alt='logo facebook' /></Link>
            <Link href='https://www.linkedin.com/in/wake-up-924779215/?originalSubdomain=fr' target='blank'><Image src={'/images/logo_linkedin.png'} width={50} height={50} alt='logo linkedin' /></Link>
          </div>
        </div>
